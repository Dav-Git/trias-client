...
function selectAll(query, elements, options = {}) {
    if (elements === null)
        return [];
    return (0, css_select_1.selectAll)(query, elements, {
        xmlMode: true,
        ...options,
    });
}
...
function selectOne(query, elements, options = {}) {
    if (elements === null)
        return null;
    return (0, css_select_1.selectOne)(query, elements, {
        xmlMode: true,
        ...options,
    });
}
...
function compile(selector, options = {}, context) {
    return (0, css_select_1.compile)(selector, {
        xmlMode: true,
        ...options,
    }, context);
}
...
function getText(node) {
    return node ? (0, domutils_1.getText)(node) : null;
}
