...
import { Document, AnyNode as DOMNode, Element as DOMElement } from "domhandler";
...
export declare function compile(selector: string, options: CssSelectOptions<DOMNode, DOMElement>, context: DOMNode | DOMNode[] | undefined): CompiledQuery<DOMElement>;
